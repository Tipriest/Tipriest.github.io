---
title: 硕士毕设-语义分割-2-使用CoT进行Open Vocabulary Label&简单实现类激活图
date: 2025-03-01
tags:
  - 硕士毕设
  - 弱监督语义分割
...
[https://zhuanlan.zhihu.com/p/29567314](https://zhuanlan.zhihu.com/p/29567314)

## 一: 采用思维链Cot优化大模型的image label效果

在上一篇文章中，主要采用了直接通过 `CLIP模型+阈值判断`的方法和通过 `VLM模型:llava`两种方法来对地形数据集的图片进行 `Image Level标注`，如下图所示：
![image.png](https://cdn.jsdelivr.net/gh/Tipriest/blog-images@main/imgs/my_blog/2025%2F04%2F05%2Ff317a4e7957cd132d084639aba273f78-20250405200458986.png)
...
- **尝试采用思维链的方式进行优化:**
  ![image.png](https://cdn.jsdelivr.net/gh/Tipriest/blog-images@main/imgs/my_blog/2025%2F04%2F05%2Fa9f2814a80c54a479f32f0dd1215ed71-20250405200517848.png)

  比如，对于下面的这张图片
  ![image.png](https://cdn.jsdelivr.net/gh/Tipriest/blog-images@main/imgs/my_blog/2025%2F04%2F05%2F9850bc36a5ddfe36f5aede861c50f26e-20250405200534961.png)
...
![image.png](https://cdn.jsdelivr.net/gh/Tipriest/blog-images@main/imgs/my_blog/2025%2F04%2F05%2Fb52a017f0c16931adbaec1a11e7bcd8b-20250405200644585.png)
...
![image.png](https://cdn.jsdelivr.net/gh/Tipriest/blog-images@main/imgs/my_blog/2025%2F04%2F05%2F3cd721cb729a0aa467a79c510cf080fd-20250405200716871.png)
![image.png](https://cdn.jsdelivr.net/gh/Tipriest/blog-images@main/imgs/my_blog/2025%2F04%2F05%2F6579009883b74ea1083954df146de186-20250405200734082.png)
